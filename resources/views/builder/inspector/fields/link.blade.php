<label class="block">
    ...
    <input type="text" placeholder="https://… atau #anchor"
        ...
        class="w-full bg-white/5 border border-white/10 px-2.5 py-2 text-xs text-stone-100 rounded focus:outline-none focus:border-white/30">
</label>
