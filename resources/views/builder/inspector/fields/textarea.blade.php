<label class="block">
    ...
    <textarea rows="3"
        ...
        class="w-full bg-white/5 border border-white/10 px-2.5 py-2 text-sm text-stone-100 rounded focus:outline-none focus:border-white/30 resize-none"></textarea>
</label>
