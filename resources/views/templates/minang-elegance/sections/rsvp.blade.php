...
<section id="rsvp" class="py-20 px-6 bg-[#F5F0E8]">
    <div class="max-w-md mx-auto">
        ...
        {{-- Sukses setelah konfirmasi (tanpa QR) --}}
        <div id="rsvp-success" class="hidden text-center py-4">
            <svg class="w-12 h-12 mx-auto text-[#7C3238] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <p class="font-serif text-[#2C1810] text-lg mb-2">Terima kasih, {{ $guest->name }}!</p>
