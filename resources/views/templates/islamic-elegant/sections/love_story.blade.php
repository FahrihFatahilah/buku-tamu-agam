<section id="love_story" class="py-20 px-6 bg-[#fdf8f0]">
        ...
        <div class="relative">
            ...
            <div class="relative flex items-start gap-6 mb-10 reveal {{ $i%2===0?'flex-row':'flex-row-reverse' }}">
                <div class="flex-1 {{ $i%2===0?'text-right':'text-left' }}">
                    ...
                    <h3 class="font-display text-lg text-[#1a4a2e] mb-1">{{ $story['title'] }}</h3>
                    <p class="text-[#1a4a2e]/50 text-sm leading-relaxed">{{ $story['description'] }}</p>
                </div>
                <div class="w-3 h-3 rounded-full bg-[#c9a84c] border-2 border-[#fdf8f0] shrink-0 mt-1.5 relative z-10"></div>
