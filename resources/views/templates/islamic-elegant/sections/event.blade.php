        ...
        <div class="space-y-10">
            ...
            <div class="reveal" style="transition-delay:{{ $loop->index*100 }}ms">
                <div class="border border-[#c9a84c]/20 p-6">
                    ...
                    @if($event->venue)
                    <p class="text-white/60 text-sm mt-3">{{ $event->venue }}</p>
                    @endif
                ...
                <a href="{{ $event->maps_url }}" target="_blank" rel="noopener"
                    class="flex items-center justify-center gap-1.5 py-2 border border-[#c9a84c]/20 border-t-0 text-xs text-[#c9a84c]/70 hover:text-[#c9a84c] transition-colors">
                    Buka di Google Maps
                </a>
                @endif
            </div>
