<section id="couple" class="py-24 px-6 bg-[#fdf5e4]">
    <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-2 gap-16">
            <div class="reveal">
                ...
                <p class="font-display text-2xl text-[#4a2c0a]">{{ $wedding->bride_name }}</p>
                ...
                @if($wedding->bride_father || $wedding->bride_mother)<p class="text-[#4a2c0a]/50 text-xs mt-3 leading-relaxed">Putri dari<br>{{ collect([$wedding->bride_father,$wedding->bride_mother])->filter()->join(' & ') }}</p>@endif
            </div>
            <div class="reveal">
                ...
                <p class="font-display text-2xl text-[#4a2c0a]">{{ $wedding->groom_name }}</p>
                ...
                @if($wedding->groom_father || $wedding->groom_mother)<p class="text-[#4a2c0a]/50 text-xs mt-3 leading-relaxed">Putra dari<br>{{ collect([$wedding->groom_father,$wedding->groom_mother])->filter()->join(' & ') }}</p>@endif
            </div>
        </div>
        @if($wedding->description)<p class="mt-12 text-[#4a2c0a]/60 text-sm leading-relaxed max-w-md mx-auto reveal">{{ $wedding->description }}</p>@endif
    </div>
</section>
