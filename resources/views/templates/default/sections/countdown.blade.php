...
<section class="py-20 px-6 tpl-invert" x-data="{
    ...
    <div class="max-w-lg mx-auto text-center">
        <p class="text-xs tracking-[0.3em] uppercase opacity-50 mb-4">Menuju Hari Bahagia</p>
        <p class="tpl-display text-2xl mb-10">{{ $wedding->date->translatedFormat('d F Y') }}</p>
