<section id="gallery" class="py-20 px-6 bg-stone-50">
    <div class="max-w-4xl mx-auto">
        <p class="text-stone-400 text-xs tracking-[0.4em] uppercase mb-12 text-center reveal">Galeri</p>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
            ...
            @empty
            @for($i=0;$i<6;$i++)<div class="aspect-square bg-stone-100 flex items-center justify-center"><span class="text-stone-300 text-xs">Foto</span></div>@endfor
            @endforelse
        </div>
    </div>
</section>
